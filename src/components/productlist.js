...
class ProductList extends Component {
    ...
    async getProducts(id) {
        try {
            ...
            let url = 'http://upkon.ir/api/ApiProduct/Product';
                ...
                <Drawer ref={(ref) => {this.drawer = ref;}}
                    ...
                    <Container>
                        <Header style={{backgroundColor: '#ffffff'}}>
                            ...
                            <Title style={styles.headerTitleText}>لیست محصولات</Title>
                            </Body>
                            <Right>
                            ...
                            <List>
                                {this.state.products.map((item, key) => (
                                    <ListItem key={key}
                                        ...
                                        <Grid>
                                            <Row>
                                                {item.TextSpecialproduct ? item.TextSpecialproduct !== '' ?
                                                    <Text style={styles.listText}>
                                                        {item.TextSpecialproduct}
                                                    </Text>
                                                    : null : null}
                                            </Row>
                                            <Row>
